...
const styles = {
  page: { minHeight: '100vh', display: 'flex', alignItems: 'center', justifyContent: 'center', background: 'linear-gradient(135deg, #FAF6F0 0%, #FEF3DC 100%)', padding: '20px' },
  card: { background: '#fff', borderRadius: '20px', padding: '40px', width: '100%', maxWidth: '400px', boxShadow: '0 12px 40px rgba(26,18,8,0.1)', border: '1px solid rgba(212,130,10,0.15)' },
  badge: { display: 'inline-block', background: '#FEF3DC', color: '#D4820A', fontSize: '11px', fontWeight: 600, padding: '6px 14px', borderRadius: '100px', marginBottom: '20px', letterSpacing: '0.5px' },
  logo: { fontSize: '28px', fontWeight: 700, color: '#1A1208', marginBottom: '6px' },
  subtitle: { fontSize: '14px', color: '#8C7B6B', marginBottom: '28px' },
  label: { display: 'block', fontSize: '13px', fontWeight: 600, color: '#4A4035', marginBottom: '6px', marginTop: '16px' },
